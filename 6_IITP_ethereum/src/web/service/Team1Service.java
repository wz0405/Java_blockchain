...
public class Team1Service {
	...
	// 계약 주소 세팅
	String contract = "0xacF92274ce4F9cEb7DefA72547e4219be457b3a0";
	Web3j web3j;
	Admin admin;
	List<String> addressList;

	public Team1Service() throws Exception { // 생성자로 한번만 호출
...
//	}
	...
	public Object totalVotesFor(String gye) throws Exception {
		// get function 호출(block생성 안함)
		Function function = new Function("totalVotesFor", Arrays.asList(new Utf8String(gye)),
	...
	public void voteForCandidate(String gye) throws Exception {
		// set function 호출

		Function function2 = new Function("voteForCandidate", Arrays.asList(new Utf8String(gye)), Collections.emptyList());
