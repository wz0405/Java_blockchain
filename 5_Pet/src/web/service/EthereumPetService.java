...
public class EthereumPetService {
	// 동일한 코드는 객체를 계속해서 만들 필요가 없음...멤버변수로 처리
	// 계약 주소 세팅
	String contract = "0x92C97E131d1F255C7BD822EDB1ea9b9f66ef052b";
	Web3j web3j;
	Admin admin;
	List<String> addressList;

	public EthereumPetService() throws Exception { // 생성자로 한번만 호출
...
//	}
	...
	public Object totalPetFor(String change) throws Exception {
		// get function 호출(block생성 안함)
		Function function = new Function("totalPetFor", Arrays.asList(new Utf8String(change)),
		...
		System.out.println(change+"[거래기록횟수]");
	...
	public void PetForChange(String change) throws Exception {
		// set function 호출

		Function function2 = new Function("PetForChange", Arrays.asList(new Utf8String(change)), Collections.emptyList());
